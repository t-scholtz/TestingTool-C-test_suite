...
const bugout = new Debugout({ realTimeLoggingOn: true,useTimestamps: true,includeSessionMetadata: true,logFilename: "00086_mod_mutant0_log.txt"});
...
bugout.log = /** @type{!function(this:Console, ...*): undefined} */ (print);
bugout.warn = bugout.error = /** @type{!function(this:Console, ...*): undefined} */ (typeof printErr !== 'undefined' ? printErr : print);
} else
...
var out = Module['print'] || bugout.log.bind(bugout);
var err = Module['printErr'] || bugout.warn.bind(bugout);
...
var wasmBinaryFile;
  wasmBinaryFile = '00086_mod_mutant0.wasm';
